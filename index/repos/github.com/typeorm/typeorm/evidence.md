...
- Discovered related relation to github.com/typeorm/typeorm from package.json repository.
- This is an overlay record, not a maintainer-controlled canonical record.

- Set `repo.name` to `typeorm` from `GitHub API` after deterministic escalation.
