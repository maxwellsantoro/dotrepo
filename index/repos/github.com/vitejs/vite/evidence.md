...
- Discovered related relation to github.com/vitejs/vite from package.json repository.
- This is an overlay record, not a maintainer-controlled canonical record.

- Set `repo.name` to `vite` from `GitHub API` after deterministic escalation.
