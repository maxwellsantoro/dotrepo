...
- Imported repo.build from apps/opik-frontend/package.json as `npm run build`.
- Imported repo.test from apps/opik-frontend/package.json as `npm test`.
- Imported repo.toolchain.min from sdks/opik_optimizer/pyproject.toml as `3.10` (Python).
