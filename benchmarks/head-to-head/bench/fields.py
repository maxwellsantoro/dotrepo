...
FIELDS = [
    ...
    Field(
        "homepage",
        "Canonical project homepage / docs URL.",
        FieldClass.GITHUB_NATIVE,
        "url",
        "repo.homepage",
    ...
    Field(
        "archived",
        "Is the repository archived / unmaintained?",
        FieldClass.GITHUB_NATIVE,
        "bool",
        "repo.archived",
    ...
    Field(
        "build",
        "Exact command to build the project from a clean checkout.",
        FieldClass.BURIED,
        "command",
        "repo.build",
