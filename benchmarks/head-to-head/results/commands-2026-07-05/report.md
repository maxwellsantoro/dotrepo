...
|---|---|
| scored questions | 40 |
| accuracy (correct / all) | 97.5% |
| precision (correct / answered) | 97.5% |
| coverage (answered / all) | 100.0% |
| **confidently wrong** (count) | 0 |
| **confidently-wrong rate** | 0.0% |
| abstained | 0 |
| approx tokens over wire | 26635 |
| total latency (ms) | 33.5 |

### Buried fields only (dotrepo's thesis)

| metric | dotrepo |
|---|---|
| buried accuracy | 100.0% |
