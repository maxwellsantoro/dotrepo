...
def put(url, status, text):
    ...
    json.dump({"url": url, "status": status, "text": text},
...
put(f"https://api.github.com/repos/{O}/{R}", 200, json.dumps({
...
put(f"https://raw.githubusercontent.com/{O}/{R}/main/README.md", 200, """# widget
...
put(f"https://raw.githubusercontent.com/{O}/{R}/main/SECURITY.md", 200,
    "Please report vulnerabilities privately to security@widget.example.")

# CONTRIBUTING absent
put(f"https://raw.githubusercontent.com/{O}/{R}/main/CONTRIBUTING.md", 404, "")
